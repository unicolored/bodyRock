...
class wp_bootstrap_tabswalker extends Walker_Nav_Menu {
	...
	*/
	function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		$output .= "\n$indent<ul role=\"menu\" class=\"nav nav-tabs\">\n";
...
$indent = ( $depth ) ? str_repeat( "\t", $depth ) : '';
		...
		$attsli['class']  = '' .(in_array('current-menu-item', $classes) ? 'active' : false);
		...
		$item_output .= '<li class="'.$attsli['class'].'"><a'. $attributes .'>';
