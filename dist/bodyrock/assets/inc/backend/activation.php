...
/*//**//**//**//*//**//**//**//*//**//**//**//*//**//**//**/
// Fonctions lancées lors de l'activation du thème via le menu Apparence.
// Cela permet par exemples d'ajouter certaines catég
/*//**//**//**//*//**//**//**//*//**//**//**//*//**//**//**/
...
/*  $bodyrock_nav_theme_mod = false;

  if (!has_nav_menu('primary_navigation')) {
    $primary_nav_id = wp_create_nav_menu('Primary Navigation', array('slug' => 'primary_navigation'));
    $bodyrock_nav_theme_mod['primary_navigation'] = $primary_nav_id;
  }

  if (!has_nav_menu('utility_navigation')) {
    $utility_nav_id = wp_create_nav_menu('Utility Navigation', array('slug' => 'utility_navigation'));
    $bodyrock_nav_theme_mod['utility_navigation'] = $utility_nav_id;
  }

  if ($bodyrock_nav_theme_mod) {
    set_theme_mod('nav_menu_locations', $bodyrock_nav_theme_mod);
  }
