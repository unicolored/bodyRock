...
class bodyrock_vcard extends WP_Widget {

  function bodyrock_vcard() {
    $widget_ops = array('description' => 'Display a vCard');
    parent::WP_Widget(false, __('Bodyrock: vCard', 'bodyrock'), $widget_ops);
  }
  ...
  ?>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('street_address'); ?>"><?php _e('Street Address:', 'bodyrock'); ?></label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('locality'); ?>"><?php _e('City/Locality:', 'bodyrock'); ?></label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('region'); ?>"><?php _e('State/Region:', 'bodyrock'); ?></label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('postal_code'); ?>"><?php _e('Zipcode/Postal Code:', 'bodyrock'); ?></label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('tel'); ?>"><?php _e('Telephone:', 'bodyrock'); ?></label>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('email'); ?>"><?php _e('Email:', 'bodyrock'); ?></label>
...
register_widget('bodyrock_vcard');
