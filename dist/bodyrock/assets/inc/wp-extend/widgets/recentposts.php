...
?>
        ...
        <fieldset>
            <p>
                <label for="<?php echo $this->get_field_id('title'); ?>">
                    <?php _e('Titre du widget','bodyrock'); ?>
                    <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
                </label>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id("class"); ?>"><?php _e( 'Classe','bodyrock' ); ?></label>
        ...
        <fieldset><legend>Affichage</legend>
            ...
            <p>
                <label for="<?php echo $this->get_field_id("wrapper"); ?>"><?php _e( 'Enveloppe','bodyrock' ); ?></label>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id("excerpt"); ?>">
                    ...
                    <?php _e( 'Inclure un extrait','bodyrock' ); ?>
                ...
                <p class="tabulate">
                    ...
                    <label for="<?php echo $this->get_field_id("excerpt_length"); ?>">
                        ...
                        <?php _e( 'Nombre de mots :','bodyrock' ); ?>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id("date"); ?>">
                    ...
                    <?php _e( 'Afficher la date','bodyrock' ); ?>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id("comment_num"); ?>">
                    ...
                    <?php _e( 'Afficher le nombre de commentaires','bodyrock' ); ?>
        ...
        <fieldset><legend>Vignette</legend>
            ...
            <p>
                <label for="<?php echo $this->get_field_id("thumb"); ?>">
                    ...
                    <?php _e( 'Afficher la vignette','bodyrock' ); ?>

                </label>
                <p class="tabulate">
                    <label for="<?php echo $this->get_field_id("thumb_pull"); ?>">
                        <?php _e('Flottement','bodyrock');	 ?>:
        ...
        <fieldset><legend>Sélection</legend>
            <p>
                <label for="<?php echo $this->get_field_id("jump"); ?>"><?php _e( 'Jump','bodyrock' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('cats'); ?>"><?php _e('Catégories :','bodyrock');?>
                    <?php
