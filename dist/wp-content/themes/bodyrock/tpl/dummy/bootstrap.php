...
// Fonction qui affiche les Titres de Rubriques TR()
function TR($titre) {
	echo '<h4 class="well margeit-top">' . br_getIcon('chevron-right') . ' ' . $titre['rubrique'] . ' <small>' . $titre['small'] . '</small></h4>';
}
?>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="bs-component">
				<!-- Page Header
				================================================== -->
				<?php TR(array('rubrique'=>'Page Header', 'small'=>'page-header')) ?>
...
<!-- Buttons
================================================== -->
<?php TR(array('rubrique'=>'Buttons', 'small'=>'btn, btn-default, ...')) ?>
...
<!-- Typography
================================================== -->
<?php TR(array('rubrique'=>'Typography', 'small'=>'h1, h2 ,h3, ...')) ?>
<div class="bs-docs-section">
	...
	<!-- Blockquotes
	================================================== -->
	<?php TR(array('rubrique'=>'Blockquotes', 'small'=>'blockquote')) ?>
	<div class="row">
		<div class="col-lg-6">
			<div class="bs-component">
				<blockquote>
...
<!-- Tables
================================================== -->
<?php TR(array('rubrique'=>'Tables', 'small'=>'table')) ?>
<div class="bs-docs-section">
...
<!-- Forms
================================================== -->
<?php TR(array('rubrique'=>'Forms', 'small'=>'form')) ?>
<div class="bs-docs-section">
...
<!-- Navs
================================================== -->
<?php TR(array('rubrique'=>'Navs', 'small'=>'nav-tabs, nav-pills, ...')) ?>
<div class="bs-docs-section">
...
<!-- Indicators
================================================== -->
<?php TR(array('rubrique'=>'Indicators', 'small'=>'.alert, ...')) ?>
<div class="bs-docs-section">
...
<!-- Progress bars
================================================== -->
<?php TR(array('rubrique'=>'Progress bars', 'small'=>'progress, progress-bar, ...')) ?>
<div class="bs-docs-section">
...
<!-- Containers
================================================== -->
<?php TR(array('rubrique'=>'Containers', 'small'=>'jumbotron, ...')) ?>
<div class="bs-docs-section">
	...
	<div class="row">
		...
		<div class="col-lg-4">
			<div class="bs-component">
				<div class="list-group">
					<a href="#" class="list-group-item"> <h4 class="list-group-item-heading">List group item heading</h4> <p class="list-group-item-text"> Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit. </p> </a>
					<a href="#" class="list-group-item"> <h4 class="list-group-item-heading">List group item heading</h4> <p class="list-group-item-text"> Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit. </p> </a>
				</div>
			</div>
		</div>
...
<!-- Dialogs
================================================== -->
<?php TR(array('rubrique'=>'Dialogs', 'small'=>'modal, ...')) ?>
<div class="bs-docs-section">
	...
	<div class="col-lg-12">
		<div class="bs-component">
			<!-- Icones
			================================================== -->
			<?php TR(array('rubrique'=>'Icones', 'small'=>BR_ICON_SET)) ?>
			<div class="page-header" id="banner">
				<div class="row">
					<div class="col-lg-12">
						<?php br_dummy('icones') ?>
