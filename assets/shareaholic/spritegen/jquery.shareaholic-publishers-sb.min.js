...
localize:!1,li_margin:0,"margin-top":20,"margin-bottom":20,"margin-left":0,"bgimg-padding-top":0,"bgimg-padding-left":0,"icon-width":60,"icon-height":29,"icon-margin-top":3,"promo-height":d.shrlink?18:0,shrlink:!1,twitter_overlay:!0},d),d=a(this);SHR4P.debug("$.fn.shareaholic_publishers called");SHR4P.debug(b);a.browser.msie&&a.browser.version<"7.0"&&(b["icon-height"]+=4);if(!b.link||b.link&&b.link==="")b.link=d.attr("data-shr_href")||document.location.href;if(!b.title||b.title&&b.title==="")b.title=
d.attr("data-shr_title")||document.title;b.bgimg!=null&&(d=a.trim(b.bgimg_padding).split(" "),b["bgimg-padding-top"]=d[0]?Number(d[0].replace(/[a-zA-Z]+/,"")):0,b["bgimg-padding-left"]=d[3]?Number(d[3].replace(/[a-zA-Z]+/,"")):0,b["margin-left"]=10);if(b.localize)b.iframe_src="/publishers.html";var c=function(){var d=0;if(!a.isEmptyObject(b.custom_link))d=a(b.custom_link).length;return b.service.split(",").length+d},f=function(){return b["margin-left"]+b["bgimg-padding-left"]},h=function(a){return Math.ceil(c()/
Math.floor((a-f())/b["icon-width"]))},g=function(a){return b.expand?b["margin-top"]+b["bgimg-padding-top"]+b["icon-height"]+b["icon-margin-top"]+(h(a)==1?b["promo-height"]:0):i(a)},i=function(a){return b["margin-top"]+b["bgimg-padding-top"]+(b["icon-height"]+b["icon-margin-top"])*h(a)+b["promo-height"]},j=function(a){SHR4P.debug("centering");var d=0;h(a)==1&&(SHR4P.debug("one row! do centering"),d=(a-f()-c()*b["icon-width"])/2,SHR4P.debug("returning "+d+" margin"));return d},k=function(a){SHR4P.debug("spacing");
...
this.href+"&tags="+b})};b.allowExternalTags?SHR4P.utils.getTags(b.link,b.tags,d):d(b.tags);d=function(b){if(b.spriteimg!="")return b.spriteimg;else if(b.localize)return b.src+"/sprite.png";else{var c=function(a,b){return a-b},d=f(b.service.split(",")).sort(c);SHR4P.debug("checking services: ");SHR4P.debug(d);var g=[];a(SHR4P.img_group).each(function(){var b=this;SHR4P.debug("checking img_group: ");SHR4P.debug(b);a(d).each(function(){SHR4P.debug("checking service: "+this);if(a.inArray(Number(this),
...
4))},getBrowserLocale:function(){var a="en-us";if(navigator)if(navigator.language)a=navigator.language;else if(navigator.browserLanguage)a=navigator.browserLanguage;else if(navigator.systemLanguage)a=navigator.systemLanguage;else if(navigator.userLanguage)a=navigator.userLanguage;return a.toLowerCase()},trackAction:function(a){apiKey="172809fde4d12743cc4a1ec894142b97f";SHR4P.jQuery("<img/>").attr({src:"//www.shareaholic.com/api/share/?v=1&apikey="+apiKey+"&apitype=3&service="+a.serviceId+"&link="+
...
g={render:!1,like:!0,unlike:!0,send:!0,share:!0,unknown:!1},i="";return{init:d,socialAction:a,trackAction:function(b){a(b.data)}}}();SHR4P.media6=function(){if(typeof SHRSB_Globals!="undefined"&&SHRSB_Globals.perfoption=="1"&&"https:"!=document.location.protocol)(new Image(0,0)).src="http://map.media6degrees.com/orbserv/hbpix?pixId=6237&pcv=43&curl="+encodeURIComponent(location.href)+"&cb="+Math.floor(Math.random()*9999999999)};
