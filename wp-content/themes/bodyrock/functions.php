...
// CHILD /////////////////////////////////////////////
// Gestion du thème child, le cas échéant
if(is_child_theme()) {
    ...
    function Child_styles_scripts() {
        ...
        wp_enqueue_script( 'rock-unid',    get_stylesheet_directory_uri().'/js/unid.js', array('jquery'), '1.0.0', false ); // Framework JS à développer
        wp_enqueue_script( 'rock-child',    get_stylesheet_directory_uri().'/js/script.js', array('jquery'), '1.0.0', false );
    }
